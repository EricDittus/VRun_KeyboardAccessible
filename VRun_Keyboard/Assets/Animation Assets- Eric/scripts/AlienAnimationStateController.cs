...
// Credit to iHeartGameDev on Youtube for the blendX/blendZ implementation and code direction which
    ...
    void Update()
    {
        ...
        if(startGame == true){
           ...
           //////// iHeartGameDev algorithm
            ...
            // turn left
            if((leftPress ) && (blendX > -2) ){
                blendX -= Time.deltaTime * acceleration;
            }   
            // turn right
            if((rightPress) && (blendX < 2) ){
                blendX += Time.deltaTime * acceleration;
            }    
            //Deceleration left/right
            if((!leftPress) && (blendX < 0)){
            ...
            if((!leftPress) && (!rightPress) && blendX != 0.0f ){
                blendX = 0.0f;
            }
            ////////
